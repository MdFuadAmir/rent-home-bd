...
const Hero = () => {
    return (
        <div>
            <div className="h-full md:h-screen p-4 w-full flex flex-col items-center justify-center bg-center" style={{backgroundImage:`url(${bgimg})`, backgroundRepeat:"no-repeat",backgroundSize:"cover"}}>
